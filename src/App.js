...
class App extends Component {
  ...
  clickedImg = imageUrl => {
    ...
    if (displayImage === imageUrl) {
      ...
      this.setState(preState => ({matchGameOver: !preState.matchGameOver}))
    }
  }
  ...
  render() {
    const {activeTabId, score, time, displayImage, matchGameOver} = this.state
    const filteredImages = this.getFilteredImages()
    return (
      <div className="bg-container">
        <NavBar gameScore={score} gameTimer={time} />
        <div className="body-container">
          {matchGameOver === true || time === 0 ? (
            <div className="game-over-container">
              ...
              <p className="score-in-digits">{score}</p>
              <button
              ...
              >
                <img
                  ...
                  className="reset-img"
                />
                <p className="playAgain-txt">PLAY AGAIN</p>
              </button>
            </div>
          ) : (
            <div className="img-app-container">
              <img src={displayImage} alt="match" className="display-img" />
